...
plt.tight_layout()
fig_path_time = output_dir / 'exp_a22_decompose_harmonics_modular_time.png'
...
plt.tight_layout()
fig_path_polar = output_dir / 'exp_a22_decompose_harmonics_modular_polar.png'
...
decomp_result, plot_data = analyze_decomposition_time(
    ...
    save_path=output_dir / 'exp_a22_decompose_harmonics_modular_wrapper_time.png',
    show_plot=False
)
print(f"  Time wrapper saved -> [{output_dir / 'exp_a22_decompose_harmonics_modular_wrapper_time.png'}]")
...
decomp_result, plot_data = analyze_decomposition_polar(
    ...
    fs=Fs,
    title=f'Static Nonlinearity (k2={k2:.3f}, k3={k3:.3f}) - Wrapper Demo',
    save_path=output_dir / 'exp_a22_decompose_harmonics_modular_wrapper_polar.png',
    show_plot=False
)
print(f"  Polar wrapper saved -> [{output_dir / 'exp_a22_decompose_harmonics_modular_wrapper_polar.png'}]")
