...
WINDOW_CONFIGS = {
    'rectangular': {'description': 'Rectangular (no window)', 'side_bins': 0},
    'hann': {'description': 'Hann (raised cosine)', 'side_bins': 1},
    'hamming': {'description': 'Hamming', 'side_bins': 1},
    'blackman': {'description': 'Blackman', 'side_bins': 2},
    'blackmanharris': {'description': 'Blackman-Harris', 'side_bins': 3},
...
plt.tight_layout()
fig_path = output_dir / 'exp_s09_window_coherent.png'
print(f"\n[Save fig] -> [{fig_path}]")
