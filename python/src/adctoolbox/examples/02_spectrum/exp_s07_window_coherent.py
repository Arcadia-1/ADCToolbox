...
print(f"[Window Comparison - Coherent Sampling]")
...
plt.tight_layout()
fig_path = output_dir / 'exp_s07_window_coherent.png'
print(f"\n[Save fig] -> [{fig_path}]")
plt.savefig(fig_path, dpi=150)
plt.close()

print("\n[Observation] With coherent sampling, all windows perform similarly (~12.5 ENOB)")
print("[Best choice] Boxcar (rectangular) - narrowest main lobe, best SFDR")
