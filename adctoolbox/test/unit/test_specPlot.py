...
def main():
    ...
    # Test Loop
    print("=== test_specPlot.py ===")
    print(f"Testing spec_plot function with {len(files_list)} datasets...\n")
    ...
    for k, current_filename in enumerate(files_list, start=1):
        ...
        # Print results
        print(f"  ENoB={ENoB:.2f}, SNDR={SNDR:.2f} dB, SFDR={SFDR:.2f} dB, "
              f"SNR={SNR:.2f} dB, THD={THD:.2f} dB\n")
